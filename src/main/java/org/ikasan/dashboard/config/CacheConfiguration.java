package org.ikasan.dashboard.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.ikasan.dashboard.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.ikasan.dashboard.repository.UserRepository.USERS_BY_EMAIL_CACHE);
